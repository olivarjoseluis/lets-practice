...
function HomePage() {
    const { getSummaryGroups, summary_groups } = useContext(VerbsContext);
    useEffect(() => {
        getSummaryGroups();
    }, []);
    return (
        <div className='home-page page mt-4'>
            <div className='home-page page mt-4'>
                <div className='container'>
                    <h3 className='text-center'>¡Elige el grupo de verbos en el que deseas Practicar!</h3>
                                    ...
                                    <Link to={'practica/grupo/' + (index + 1)} className="link-card">
                                        <div className='card card-groups  text-center'>
                                            <div className='text-card-group'>
                                                ...
                                                <p className='p-card-group'>{item.count} verbos</p>
                                            </div>
