...
import VocabubulariesContext from '../context/vocabulary/VocabulariesContext';
...
function PracticePage() {
  ...
  const { getEspecificGroup, especific_group } = useContext(VocabubulariesContext);
              ...
              count < test.length ?
                ...
                <div className='card card-practice p-3 justify-content-center align-items-center' >
                  ...
                  <div className="footer-final">
                    <Link className='btn btn-lg btn-primary mt-4' to="/vocabularios">Volver al inicio</Link>
                  </div>
                </div>
              :
